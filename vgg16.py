...
class Vgg16:
    def __init__(self, model_path=None, learning_rate=1e-3, decay=0.95, decay_step=200, decay_factor=0.1):
        # TODO load the model
    ...
    def inference(self, images, is_train):
        ...
        assert images.get_shape().as_list()[1:] == [FLAGS.image_size, FLAGS.image_size, 3]
        ...
        self.fc8 = self.fc_layer(self.relu7, FLAGS.NUM_CLASSES, "fc8")
    ...
    def train(self, total_loss, global_step):
        ...
        train_op = tf.train.RMSPropOptimizer(self.INITIAL_LEARNING_RATE, decay=self.decay, epsilon=1e-10).minimize(self.cross_entropy)
